...
-- Timestamps are UTC, like everything the app writes with datetime('now'). The fictional
-- night shift runs 19:00 to 07:00 US Eastern (EDT, UTC-4), so it is stored as 23:00 to 11:00.
...
VALUES ('night', '2026-04-05 23:00:00', '2026-04-06 11:00:00', 'emergency', 1);
...
VALUES
('4829103', 'Martinez, R.', 67, 'M', 'STEMI: cath lab activated, on heparin drip, cardiology en route', 'T1', '2026-04-05 22:42:00', 1, 'admit', 1),
('7391024', 'Johnson, T.', 45, 'F', 'MVC with LOC, GCS 11 on arrival, CT head pending, c-collar in place', 'T2', '2026-04-06 00:15:00', 1, 'undecided', 1),
('5520381', 'Williams, A.', 78, 'M', 'Acute on chronic CHF exacerbation, BiPAP initiated, BNP 2400, troponin negative x2', '12', '2026-04-05 21:30:00', 2, 'admit', 1),
('8843210', 'Chen, L.', 52, 'F', 'Sepsis: lactate 4.2, blood cultures drawn, broad-spectrum abx started, 2L NS given', '08', '2026-04-05 23:45:00', 2, 'admit', 2),
('6617892', 'Patel, S.', 34, 'M', 'RLQ pain, CT showing acute appendicitis, surgery consulted, NPO, morphine given', '15', '2026-04-06 01:00:00', 3, 'admit', 2),
('9920147', 'Davis, K.', 28, 'F', 'Asthma exacerbation, continuous nebs x3, O2 sat 92% on RA improving to 96% post-treatment', '20', '2026-04-06 02:10:00', 3, 'observe', 3),
('3310458', 'Brown, J.', 42, 'M', 'Laceration R forearm, 6cm, cleaned and sutured, tetanus updated, follow-up PCP 10 days', '22', '2026-04-06 00:30:00', 4, 'discharge', 3),
('7712033', 'Garcia, M.', 55, 'F', 'UTI with flank pain, UA positive, urine culture sent, cipro started, tolerating PO fluids', '18', '2026-04-06 01:45:00', 4, 'discharge', 2);
...
(1, 1, 1, 2, 'critical', 'Full Code',
 ...
 'ipass', 'sent', '2026-04-06 03:30:00'),
...
(3, 1, 1, 2, 'serious', 'Full Code',
 ...
 'ipass', 'acknowledged', '2026-04-06 02:45:00');

-- Action items for handoff 1 (STEMI patient)
INSERT INTO action_items (handoff_id, description, priority, due_by, assigned_to)
VALUES
(1, 'Check PTT in 2 hours (target 60-80), adjust heparin per protocol', 'stat', '2026-04-06 05:30:00', 2),
(1, 'Serial troponins q6h; next due 00:42', 'urgent', '2026-04-06 04:42:00', 2),
(1, 'Follow up with cath lab for procedure timing update', 'urgent', NULL, 2);

-- Mark one action as completed
UPDATE action_items SET completed = 1, completed_at = '2026-04-06 03:45:00', completed_by = 2 WHERE id = 3;

-- Action items for handoff 3 (CHF patient)
INSERT INTO action_items (handoff_id, description, priority, due_by, assigned_to)
VALUES
(3, 'Repeat BMP in 6 hours (due ~04:45)', 'urgent', '2026-04-06 08:45:00', 2),
